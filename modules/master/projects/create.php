            ...
            <form method="POST">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Project Manager (PM) <small class="text-muted">(Opsional)</small></label>
                                ...
                                <small class="form-text text-muted">Hanya menampilkan user dengan role Project Manager.</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">Lokasi ini akan digunakan sebagai alamat drop-point di Surat Jalan / Receiving.</small>
                    </div>
                    
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Tgl. Mulai Proyek <small class="text-muted">(Opsional)</small></label>
                                <input type="date" name="start_date" class="form-control" value="<?= sanitize($_POST['start_date'] ?? '') ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Tgl. Selesai Target <small class="text-muted">(Opsional)</small></label>
                    ...
                    <div class="form-group">
                        <label>Nilai Rencana Anggaran (Budget) <small class="text-muted">(Opsional)</small></label>
