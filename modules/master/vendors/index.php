...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div class="ml-auto">
            ...
            <a href="<?= APP_URL ?>/modules/master/export_excel.php?type=vendors" class="btn btn-info btn-sm ml-1">
    ...
    <div class="card-body">
        <table id="vendorsTable" class="table table-bordered table-striped table-hover table-sm w-100" >
            <thead>
                <tr>
                    <th width="5%">No</th>
                    <th width="8%">Kode</th>
