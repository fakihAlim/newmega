...
<div class="card card-outline card-primary">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h3 class="card-title text-primary font-weight-bold">Form Input Claim Nota</h3>
        <a href="index.php" class="btn btn-secondary btn-sm ml-auto"><i class="fas fa-arrow-left mr-1"></i> Kembali</a>
    </div>
        ...
        <div class="card-body bg-light">
            <div class="row">
                ...
                <div class="col-md-6 border-right">
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label">Karyawan <span class="text-danger">*</span></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label">Perusahaan <span class="text-danger">*</span></label>
                        <div class="col-sm-8">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label">Tanggal Klaim <span class="text-danger">*</span></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label">Catatan Klaim</label>
                        <div class="col-sm-8">
            ...
            <div class="card card-outline card-info mb-4 d-print-none shadow-sm">
                <div class="card-header py-2">
                    <h3 class="card-title font-weight-bold text-info" style="font-size:14px;">Scan Nota Otomatis dengan AI</h3>
                </div>
            ...
            <div class="d-flex justify-content-end mb-3">
                <button type="button" class="btn btn-sm btn-info" id="btnAddRow"><i class="fas fa-plus mr-1"></i>Tambah Baris</button>
            </div>
