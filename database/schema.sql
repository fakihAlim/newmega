...
-- =============================================
-- 16. CLAIM NOTA (Employee Reimbursement)
-- =============================================
CREATE TABLE IF NOT EXISTS claim_notas (
    id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    reimbursement_reference VARCHAR(50),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (project_id) REFERENCES projects(id),
    FOREIGN KEY (company_id) REFERENCES companies(id),
...
CREATE TABLE IF NOT EXISTS claim_nota_items (
    id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    total DECIMAL(15,2) DEFAULT 0,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (claim_id) REFERENCES claim_notas(id) ON DELETE CASCADE,
    FOREIGN KEY (item_id) REFERENCES items(id)
) ENGINE=InnoDB;
